...
=for :list
1. Test effect of varying clustalw alignment parameter(s) on resulting
  alignment
2. Test effect of changing the order that sequences are added to the
  alignment on the resulting alignment
